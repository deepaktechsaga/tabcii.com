...
class Car extends CI_Controller {
	...
	public function manage_log()
	{
	    if($this->session->userdata('is_admin_logged'))
		{
			...
			$config["base_url"] = base_url()."car/manage_log";
			...
			$data["log_data"] = $this->Ve_model->get_rows_limit('car_enquiry','id','desc',$config["per_page"], $page); //print_r($data["user_data"]); die();		
			$data["total_rows"] =  $query->num_rows(); 

			$this->load->view('admin/header');		
			$this->load->view('admin/car/manage-booking-log',$data);
	...
	public function view_log()
	{
	    if($this->session->userdata('is_admin_logged'))
		{
			...
			$this->load->view('admin/header');		
			$this->load->view('admin/car/view-booking-log',$data);
			$this->load->view('admin/footer'); 			
		}
		else
		{
