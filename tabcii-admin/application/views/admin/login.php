...
<title>Travel Booking | Admin Login</title>
...
<div class="login-form">    
    <form action="<?php echo base_url();?>admin/login" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control user_email" name="username" placeholder="username">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control user_pass" name="password" placeholder="Password">
