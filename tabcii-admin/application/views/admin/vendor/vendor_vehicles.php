...
<div class="boxed">
  ...
  <div id="content-container">
    ...
    <div class="pageheader hidden-xs">
      <h3><i class="fa fa-home"></i> Vehicles List</h3>
        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Vehicles List</h3>
            </div>
                ...
                <table class="table table-bordered table-hover dataTable" >
                  <thead>
                    <tr role="row">
                      ...
                      <th >Vehicle RC</th>
                      <th >Vehicle Insurence No</th>
                      <th >Company Name</th>                                        
                    </tr>
                  </thead>
                  <tbody>
                  <?php $i=1; foreach($vehicles as $data) { ?>            
                    <tr role="row" class="odd record">
                      <td> <?= $i ?> </td>
                      <td> <?= $data['vehicle_type']?> </td>
                      <td> <?= $data['vehicle_no']?> </td>
                      <td> <?= $data['vehicle_rc']?> </td>
                      <td> <?= $data['vehicle_insurance']?> </td>
