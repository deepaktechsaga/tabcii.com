...
// login methods
public function do_login_c1($table_name,$field1,$val1,$field2,$val2,$field3,$val3)
  {
    $this->db->select('*');
    $this->db->where($field1,$val1);
    $this->db->where($field2,$val2);
...
public function do_login_c5($table_name,$field1,$val1,$field2,$val2,$field3,$val3,$field4,$val4,$field5,$val5)
{
    $this->db->select('*');
    $this->db->where($field1,$val1);
    $this->db->where($field2,$val2);
...
function check_exist_data_c3($table_name,$field1,$val1,$field2,$val2,$field3,$val3)
{
    $this->db->select('*');
    $this->db->where($field1,$val1);        
    $this->db->where($field2,$val2);        
...
function check_exist_data_c5($table_name,$field1,$val1,$field2,$val2,$field3,$val3,$field4,$val4,$field5,$val5)
{
    $this->db->select('*');
    $this->db->where($field1,$val1);        
    $this->db->where($field2,$val2);        
...
// get single row based on 4 condition
function get_rows_c4_order_by($table_name,$col1,$val1,$col2,$val2,$col3,$val3,$col4,$val4,$order_col,$order_val)
{ 
  $this->db->where($col1,$val1);
  $this->db->where($col2,$val2);
  $this->db->where($col3,$val3);
...
// get all rows on condition 4
function get_rows_c4($table_name,$col1,$val1,$col2,$val2,$col3,$val3,$col4,$val4)
{ 
  $this->db->where($col1,$val1);
  $this->db->where($col2,$val2);
  $this->db->where($col3,$val3);
...
// rows count on condition 1 column | return no of rows 
public function row_count_c3($table_name,$col1,$val1,$col2,$val2,$col3,$val3) {
      $this->db->where($col1,$val1);
      $this->db->where($col2,$val2);
      $this->db->where($col3,$val3);
      $query= $this->db->get($table_name);
...
// get rows inner join multiple row on 3 column condition 
public function get_row_inner_join_c3($table1,$table2,$common_col,$col_c1,$col_c1_val,$col_c2,$col_c2_val,$col_c3,$col_c3_val)
{ 
  $this->db->select('*');
  $this->db->from($table1);
  $this->db->join($table2, $common_col,'inner');      
...
//get rows inner join multiple row on one column condition order by
public function get_rows_inner_join_c1_order_limit($table1,$table2,$common_col,$col_c1,$col_c1_val,$order_col,$order_val,$limit,$offset)
{ 
  $this->db->select('*');
  $this->db->from($table1);
  $this->db->join($table2, $common_col,'inner');      
...
// delete one row on two column condition
function delete_row_c2( $table_name,$col1,$val1,$col2,$val2)
{
  //delete record  
  $this->db->where($col1,$val1);
  $this->db->where($col2,$val2);
...
function getAllVendorsVehicle(){
  $this->db->select('*')->from('vehicle vh')->join('vendor v','vh.user_id=v.id');
  $query = $this->db->get();
  return $query->result_array(); 
}
