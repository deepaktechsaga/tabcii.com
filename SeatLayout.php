...
section.seatLayout {
    margin-top: 6%;
    background: url(http://tabcii.com/assets/images/background/bg-1.jpg);
    padding: 4% 0 5% 0;
}
form.seatTable {
...
/*.seatLayout .col-md-12 br{ display: none; } 
.seatLayout .col-md-12 br + br{ display: block; } */
</style>
...
<section class="seatLayout">
    ...
    <div class="col-md-6 col-md-offset-3">
      ...
      /*      include_once "library/OAuthStore.php";
            ...
            echo "<form method='POST' action='generateForm.php' name='form3' onSubmit='' class='seatTable'>";
                ...
                */
                ...
                echo "<div>Seats</div>";
                echo "<textarea id='t' name='seatnames' class='form-control' required>Seats:</textarea><br><br>";
                ...
                $listout="<select onChange='BoardingPoint(this.value,\"".$chosentripid."\")' id='boardingpointsList' name='boardingpointsList' class='form-control'>";
                    if(is_array($v1))
                    {
                    foreach ($v1 as $v1)
                    {
            ...
            echo "<input type='hidden' name='chosenbus' class='btnclass' value='".$chosenbusid."' /></td></br></br>";
            echo "<input type='submit' value='Continue' class='btn btn-primary'>";
            echo "</div></div>";
            ?>
        </div>
     </div>
