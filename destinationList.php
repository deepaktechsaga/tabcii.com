...
<?php
	...
	$selectControlForDestination = "<div class='form-field field-select field-style'><span> To:</span> <select onChange='validateForm($storesource,this.value)' id='destinationList' name='destinationList' class='form-control vehicle_type'>";
	...
	$selectControlForDestination = $selectControlForDestination."</select></div>";
