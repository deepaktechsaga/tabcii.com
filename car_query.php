...
<?php 
    ...
    if(!isset($_SESSION['carQueryActive']))
    {
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <p>
                                        <?= $_SESSION['trip_type']; ?></p>
                                    </div>
                                    <div class="col-md-2">
                                        <label>From </label>
                                        <p>
                                        <?php if(is_numeric($_SESSION['sourceCity'])){$source=getLocationName('source_city','source_id',$_SESSION['sourceCity'],'source_name',$conn);echo $source; $_SESSION['source']=$source; }else{ echo $_SESSION['sourceCity'];}?></p>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Destination</label>
                                        <p>
                                        <?php if(is_numeric($_SESSION['destinationcity'])){$destination=getLocationName('destination_city','destination_id',$_SESSION['destinationcity'],'destination_name',$conn); echo $destination; $_SESSION['destination']=$destination;}else{ echo $_SESSION['destinationcity'];}?>
                                       </p>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Pick Date</label>
                                        <p>
                                        <?= $_SESSION['pickup_date']; ?></p>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Drop Date</label>
                                        <p>
                                        <?= $_SESSION['drop_date']; ?></p>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Seater</label>
                                        <p>
                                        <?= $_SESSION['seater']; ?> Seater</p>
                                    </div>
                                </div>
                            </div><!-- ./form-group -->  
