    ...
    <form name='form2' id='form2' method='get' action='SeatLayout.php'>
      ...
      $travelsListnew=array_unique($travelsList);
          ...
          echo "<div class='side-by-side clearfix' > <div>";
            $dropdownTravels = "<div class='col-md-6 ChooseTravels'><select data-placeholder='Choose a travels' multiple='multiple' class='chosen-select' id='Travel[]' name='Travel[]'>";
              for ($t=0; $t <$j ; $t++)
              {
            ...
            $dropdownTravels=$dropdownTravels."</select></div>";
            echo "<div class='col-md-2'> <h4>Travels</h4></div>";
            echo $dropdownTravels;
           
          ?>
          <div class='col-md-3'><div class='T_button'>
            <input type='button' class="btn btn-primary" onclick="submitForm('BusServiceList.php')" value='Filter by Travels'></div></div>
      ...
      <table frame='box' border="20" cellpadding="10" align="center" width="100%">
        ...
        echo "<tbody>";
          ...
          echo "<tr>";
            ...
            echo "<td style='text-align:center'><button type='submit' name='chosentwo' class='btn btn-primary' value='".$busID[$i]."'/>View Seats</button></td>";
          ...
          <table border="0" cellpadding="0">
            ...
            echo "<tbody>";
              ...
              echo "<tr>";
                ...
                echo "<input type='hidden' name='destinationList' class='btnclass' value='".$destid."'/>";
                echo "<input type='hidden' name='datepicker' class='btnclass' value='".$date."'/>";
                echo "<td style='text-align:center'><button type='submit' name='chosenone' class='btn btn-primary' value='".$storebusid."'/>View Seats</button></td>";
                echo"<td><a onclick=\"showText('".$countrows."')\" href=\"javascript:void(0)\">More Information / Cancellation Policy</a>";
